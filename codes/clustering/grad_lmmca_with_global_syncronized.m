function [fval, grad] = grad_lmmca_with_global_syncronized(w, auxdata)
...
[scores, global_latent_var_assignments, latent_var_assignments_subject_1, latent_var_assignments_subject_2] = ...
    infer_global_latent_variables_syncronized(latent_w, global_w, auxdata);
...
latent_grad_subject_2 = zeros(dim, kc); % left part is for the first subject and right part is for second subject
    ...
    for n = 1:kc
        ...
        if p == 0
            ...
            if ~isempty(latent_data)
                ...
                latent_currgrad_subject_2(:, p) = - latent_data(latent_var_assignments_subject_2(i,p), :)';
                latent_currgrad_subject_2(:, n) = latent_data(latent_var_assignments_subject_2(i,n), :)';    
            end
        ...
        latent_grad_subject_2 = latent_grad_subject_2 + latent_currgrad_subject_2;
        global_grad = global_grad + global_currgrad;
    end
end
latent_grad_subject_1 = latent_grad_subject_1(:);
latent_grad_subject_1 = latent_grad_subject_1';
latent_grad_subject_2 = latent_grad_subject_2(:);
latent_grad_subject_2 = latent_grad_subject_2';
...
latent_grad_subject_2 = latent_grad_subject_2 / kc;
global_grad = global_grad / kc;
grad = [global_grad, latent_grad_subject_1, latent_grad_subject_2];
