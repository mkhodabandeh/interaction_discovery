function [groups, pairs, scores, num_labeled_data] = user_feedback_old_virat(w, auxdata)
...
[scores, ~] = infer_latent_variables(w0, w1, auxdata);
...
%% Initializations and some checking before getting user feedback
pairs = auxdata.pairs;
