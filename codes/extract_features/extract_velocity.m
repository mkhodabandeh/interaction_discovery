...
for scene_counter = 1:size(scenes,1)
    ...
    for o = 1:length(objects)
        ...
        %mkdir([data_address filesep 'VIRAT' filesep scene]);
        %save([data_address filesep 'VIRAT' filesep scene filesep objects(o).name(1:end-length(['.viratdata.objects.txt'])) '.mat'], 'obj', 'number_of_tracklets', 'number_of_tracks');
        save([data_address filesep 'VIRAT' filesep scene filesep objects(o).name(1:end) '.mat'], 'obj', 'number_of_tracklets', 'number_of_tracks');
    end
end