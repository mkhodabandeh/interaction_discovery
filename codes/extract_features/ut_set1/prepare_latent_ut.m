...
%    clip_length = 8;
    ...
    size(track_ids)
    %}
    %gmm_hoghof_data = gmm_fit(hoghof, hog_hof_number_of_centers, 1);
    %save([table_address vid_name '_small_hoghof_gmm_1_' num2str(hog_hof_number_of_centers) '.mat'], 'gmm_hoghof_data');
    %return;
    load([table_address vid_name '_small_hoghof_gmm_' num2str(rate) '_' num2str(hog_hof_number_of_centers) '.mat']);
    track_counter = 1;
    %t = 1;
