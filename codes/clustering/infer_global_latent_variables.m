function [ scores, global_latent_var_assignments, latent_var_assignment_subject_1, latent_var_assignment_subject_2] = infer_global_latent_variables( latent_w, global_w, auxdata )
...
latent_scores_2 = zeros(size(global_scores_2));
latent_var_assignment_subject_1 = zeros(size(global_scores_1));
latent_var_assignment_subject_2 = zeros(size(global_scores_2));
...
if ~isempty(latent_data)
    ...
    [latent_scores_1_subject1, latent_var_assignments_1_subject1] = infer_latent_variables(latent_w_1, auxdata_1);
    [latent_scores_1_subject2, latent_var_assignments_1_subject2] = infer_latent_variables(latent_w_2, auxdata_2);
    [latent_scores_2_subject1, latent_var_assignments_2_subject1] = infer_latent_variables(latent_w_1, auxdata_2);
    [latent_scores_2_subject2, latent_var_assignments_2_subject2] = infer_latent_variables(latent_w_2, auxdata_1);
    
    
    latent_scores_1 = latent_scores_1_subject1 + latent_scores_1_subject2;
    latent_scores_2 = latent_scores_2_subject1 + latent_scores_2_subject2;
...
if ~isempty(latent_data)
    for i = 1:size(global_latent_var_assignments, 1)
        for j = 1:size(global_latent_var_assignments, 2)
            ...
            latent_var_assignment_subject_2(i,j) = latent_var_assignments_subject_2(i,j, global_latent_var_assignments(i,j));
        end
    end
end
