function [ scores, global_latent_var_assignments, latent_var_assignment_subject1, latent_var_assignment_subject2 ] = infer_global_latent_variables_syncronized( latent_w, global_w, auxdata )
...
latent_var_assignment_subject1 = zeros(size(global_scores_1));
latent_var_assignment_subject2 = zeros(size(global_scores_1));

if ~isempty(latent_data)
    auxdata_1 = struct;
    auxdata_1.latent_data = struct;
    auxdata_1.kc = auxdata.kc;
    auxdata_1.latent_data.larger_tracklet_1 = auxdata.latent_data.larger_tracklet(1:end/2); % first part contains subject 1 and second part contains data of subject 2
    auxdata_1.latent_data.larger_tracklet_2 = auxdata.latent_data.larger_tracklet(end/2 + 1:end); % first part contains subject 1 and second part contains data of subject 2
    auxdata_2 = struct;
    auxdata_2.latent_data = struct;
    auxdata_2.kc = auxdata.kc;
    auxdata_2.latent_data.larger_tracklet_1 = auxdata.latent_data.larger_tracklet(end/2+1:end); % first part contains subject 1 and second part contains data of subject 2
    auxdata_2.latent_data.larger_tracklet_2 = auxdata.latent_data.larger_tracklet(1:end/2); % first part contains subject 1 and second part contains data of subject 2
    
    latent_w_1 = latent_w(1:end/2);
    latent_w_2 = latent_w(end/2 + 1:end);
    
    [latent_scores_1, latent_var_assignments_1_subject1, latent_var_assignments_1_subject2] = infer_latent_variables_sync(latent_w_1, latent_w_2, auxdata_1);
    [latent_scores_2, latent_var_assignments_2_subject1, latent_var_assignments_2_subject2] = infer_latent_variables_sync(latent_w_1, latent_w_2, auxdata_2);
    

    latent_var_assignments_subject_1 = cat(3, latent_var_assignments_1_subject1, latent_var_assignments_2_subject1); 
    latent_var_assignments_subject_2 = cat(3, latent_var_assignments_1_subject2, latent_var_assignments_2_subject2); 
...
if ~isempty(latent_data)
    for i = 1:size(global_latent_var_assignments, 1)
        for j = 1:size(global_latent_var_assignments, 2)
            latent_var_assignment_subject1(i,j) = latent_var_assignments_subject_1(i,j, global_latent_var_assignments(i,j));
            latent_var_assignment_subject2(i,j) = latent_var_assignments_subject_2(i,j, global_latent_var_assignments(i,j));
        end
    end
end
